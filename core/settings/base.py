...
SECRET_KEY = 'django-insecure-&rvi4$l*p3du3uw&f)681km6luzfm9&ui-(#@2736l8&z%yldp'
...
# Third-party Config
from .third_party.restframework import *
from .third_party.versatileimage import *
from .third_party.simplejwt import SIMPLE_JWT
